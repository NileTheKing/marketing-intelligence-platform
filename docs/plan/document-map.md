...
| `docs/plan/db-jpa-integrity-audit-2026-08-11.md` | active | DB/JPA integrity audit, OCI schema evidence, UserSummary atomic update, per-activity stock transaction, coupon/product locks, and deferred migration boundary |
